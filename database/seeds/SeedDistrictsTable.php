...
class SeedDistrictsTable extends Seeder
{
	public function run()
	{
		...
		foreach ($districts as $key => $district) {
            $city = City::where('title', $district['name'])->firstOrFail();
            foreach ($district['lines'] as $i => $line) {
                $districtLine = DistrictLine::create([
                    'title' => $line['name'],
                ...
                foreach($line['stations'] as $j => $station) {
                    $stations[] = [
        ...
        DistrictStation::insert($stations);
	}
